...
sub handle_target {
    ...
    my $organism_id = '1618' #by peu dummy organims for iprscan match feature
    #my $organism_id = $self->organism_id;  #comment out by peu
...
sub create_target_feature {
 ...
 $self->print_f($self->nextfeature, '1618' , $name,$tuniquename , $type, '\N','\N'); #added by peu
